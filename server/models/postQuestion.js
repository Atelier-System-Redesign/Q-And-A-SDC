...
module.exports = async (productId, body, date, name, email, reported, helpful) => {
  ...
  try {
    const query = 'INSERT INTO questions (question_id, product_id, question_body, question_date, asker_name, asker_email, reported, question_helpfulness) VALUES ((SELECT COUNT (DISTINCT question_id) FROM questions)+1, $1, $2, $3, $4, $5, $6, $7)';
